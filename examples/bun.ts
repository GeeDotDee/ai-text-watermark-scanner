// Run with: bun run examples/bun.ts
// Or with package import: bun run -e 'import { scanText } from "ai-text-watermark-scanner"; console.log(scanText("test\u200B"))'
...
console.log("=== AI Text Watermark Scanner (Bun) ===");
